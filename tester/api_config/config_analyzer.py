...
class TensorConfig:
    ...
    def _handle_margin_cross_entropy():
    ...
    def _handle_softmax_with_cross_entropy():
    ...
    def _handle_class_center_sample():
    ...
    def _handle_put_along_axis_etc():
