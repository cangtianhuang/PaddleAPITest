...
class TensorConfig:
    __slots__ = ['shape', 'dtype', 'place', 'numpy_tensor', 'paddle_tensor', 'torch_tensor', 'index', 'key']

    _API_HANDLERS = {
        "paddle.arange": "_handle_arange",
        "paddle.argmax": "_handle_argmax_etc",
        "paddle.argmin": "_handle_argmax_etc",
        "paddle.Tensor.argmax": "_handle_argmax_etc",
        "paddle.Tensor.argmin": "_handle_argmax_etc",
        "paddle.atan2": "_handle_atan2",
        "paddle.bernoulli": "_handle_bernoulli",
        "paddle.bincount": "_handle_bincount",
        "paddle.incubate.nn.functional.block_multihead_attention": "_handle_block_multihead_attention",
        "paddle.chunk": "_handle_chunk",
        "paddle.nn.functional.conv2d_transpose": "_handle_conv2d_transpose",
        "paddle.cumsum": "_handle_cumsum",
        "paddle.clip": "_handle_clip",
        "paddle.vision.ops.distribute_fpn_proposals": "_handle_distribute_fpn_proposals",
        "paddle.nn.functional.dropout": "_handle_dropout_etc",
        "paddle.nn.functional.dropout2d": "_handle_dropout_etc",
        "paddle.nn.functional.dropout3d": "_handle_dropout_etc",
        "paddle.empty": "_handle_empty",
        "paddle.eye": "_handle_eye",
        "paddle.expand": "_handle_expand_etc",
        "paddle.Tensor.expand": "_handle_expand_etc",
        "paddle.full": "_handle_full",
        "paddle.gammainc": "_handle_gammainc_etc",
        "paddle.gammaincc": "_handle_gammainc_etc",
        "paddle.vision.ops.generate_proposals": "_handle_generate_proposals",
        "paddle.geometric.segment_max": "_handle_segment_etc",
        "paddle.geometric.segment_mean": "_handle_segment_etc",
        "paddle.geometric.segment_min": "_handle_segment_etc",
        "paddle.geometric.segment_sum": "_handle_segment_etc",
        "paddle.geometric.sample_neighbors": "_handle_sample_neighbors",
        "paddle.geometric.send_u_recv": "_handle_send_etc",
        "paddle.geometric.send_ue_recv": "_handle_send_etc",
        "paddle.geometric.send_uv": "_handle_send_etc",
        "paddle.index_add": "_handle_index_add_etc",
        "paddle.index_fill": "_handle_index_add_etc",
        "paddle.index_sample": "_handle_index_sample",
        "paddle.incubate.nn.functional.fused_rotary_position_embedding": "_handle_fused_rotary_position_embedding",
        "paddle.incubate.segment_max": "_handle_incubate_segment_etc",
        "paddle.incubate.segment_mean": "_handle_incubate_segment_etc",
        "paddle.incubate.segment_min": "_handle_incubate_segment_etc",
        "paddle.incubate.segment_sum": "_handle_incubate_segment_etc",
        "paddle.logspace": "_handle_logspace",
        "paddle.linalg.cholesky": "_handle_linalg_cholesky",
        "paddle.linalg.cov": "_handle_linalg_cov",
        "paddle.linalg.eigh": "_handle_linalg_eigh",
        "paddle.linalg.lstsq": "_handle_linalg_lstsq",
        "paddle.linalg.lu_unpack": "_handle_linalg_lu_unpack",
        "paddle.linalg.pca_lowrank": "_handle_linalg_pca_lowrank",
        "paddle.linspace": "_handle_linspace",
        "paddle.incubate.nn.functional.masked_multihead_attention": "_handle_masked_multihead_attention",
        "paddle.matrix_transpose": "_handle_matrix_transpose",
        "paddle.mean": "_handle_reduce",
        "paddle.max": "_handle_reduce",
        "paddle.min": "_handle_reduce",
        "paddle.multinomial": "_handle_multinomial",
        "paddle.multiplex": "_handle_multiplex",
        "paddle.multiply": "_handle_multiply",
        "paddle.nn.functional.max_unpool1d": "_handle_max_unpool_etc",
        "paddle.nn.functional.max_unpool2d": "_handle_max_unpool_etc",
        "paddle.nn.functional.max_unpool3d": "_handle_max_unpool_etc",
        "paddle.vision.ops.nms": "_handle_nms",
        "paddle.nn.functional.adaptive_avg_pool2d": "_handle_adaptive_avg_pool_etc",
        "paddle.nn.functional.adaptive_max_pool3d": "_handle_adaptive_avg_pool_etc",
        "paddle.nn.functional.adaptive_log_softmax_with_loss": "_handle_adaptive_log_softmax_with_loss",
        "paddle.nn.functional.affine_grid": "_handle_affine_grid",
        "paddle.nn.functional.alpha_dropout": "_handle_alpha_dropout",
        "paddle.nn.functional.interpolate": "_handle_interpolate",
        "paddle.nn.functional.gather_tree": "_handle_gather_tree",
        "paddle.nn.functional.gaussian_nll_loss": "_handle_gaussian_nll_loss",
        "paddle.nn.functional.hsigmoid_loss": "_handle_hsigmoid_loss",
        "paddle.nn.functional.upsample": "_handle_upsample",
        "paddle.nn.functional.binary_cross_entropy": "_handle_binary_cross_entropy",
        "paddle.nn.functional.embedding": "_handle_embedding",
        "paddle.nn.functional.margin_cross_entropy": "_handle_margin_cross_entropy",
        "paddle.nn.functional.multi_margin_loss": "_handle_multi_margin_loss",
        "paddle.nn.functional.cross_entropy": "_handle_cross_entropy",
        "paddle.nn.functional.ctc_loss": "_handle_ctc_loss",
        "paddle.nn.functional.dice_loss": "_handle_dice_loss",
        "paddle.nn.functional.nll_loss": "_handle_nll_loss",
        "paddle.nn.functional.one_hot": "_handle_one_hot",
        "paddle.nn.functional.rnnt_loss": "_handle_rnnt_loss",
        "paddle.nn.functional.sequence_mask": "_handle_sequence_mask",
        "paddle.nn.functional.softmax_with_cross_entropy": "_handle_softmax_with_cross_entropy",
        "paddle.normal": "_handle_normal",
        "paddle.ones": "_handle_ones",
        "paddle.nn.functional.pad": "_handle_pad",
        "paddle.nn.functional.class_center_sample": "_handle_class_center_sample",
        "paddle.prod": "_handle_prod",
        "paddle.vision.ops.psroi_pool": "_handle_psroi_pool",
        "paddle.put_along_axis": "_handle_put_along_axis_etc",
        "paddle.Tensor.put_along_axis": "_handle_put_along_axis_etc",
        "paddle.quantile": "_handle_quantile",
        "paddle.reshape": "_handle_reshape_etc",
        "paddle.Tensor.reshape": "_handle_reshape_etc",
        "paddle.vision.ops.roi_align": "_handle_roi_align_etc",
        "paddle.vision.ops.roi_pool": "_handle_roi_align_etc",
        "paddle.repeat_interleave": "_handle_repeat_interleave",
        "paddle.slice": "_handle_slice",
        "paddle.scatter": "_handle_scatter",
        "paddle.scatter_nd": "_handle_scatter_nd",
        "paddle.scatter_nd_add": "_handle_scatter_nd_add",
        "paddle.shard_index": "_handle_shard_index",
        "paddle.sum": "_handle_sum_etc",
        "paddle.squeeze": "_handle_sum_etc",
        "paddle.split": "_handle_split",
        "paddle.nn.functional.softmax": "_handle_softmax",
        "paddle.standard_gamma": "_handle_standard_gamma",
        "paddle.standard_normal": "_handle_standard_normal",
        "paddle.strided_slice": "_handle_strided_slice",
        "paddle.tensordot": "_handle_tensordot",
        "paddle.take_along_axis": "_handle_take_along_axis_etc",
        "paddle.Tensor.take_along_axis": "_handle_take_along_axis_etc",
        "paddle.Tensor.clip": "_handle_clip_tensor",
        "paddle.gather": "_handle_gather_etc",
        "paddle.Tensor.gather": "_handle_gather_etc",
        "paddle.gather_nd": "_handle_gather_nd_etc",
        "paddle.Tensor.gather_nd": "_handle_gather_nd_etc",
    }

    _NOT_ZERO_APIS = frozenset([
    ...
    def get_numpy_tensor(self, api_config, index=None, key=None, **kwargs):
        ...
        if self.numpy_tensor is not None:
    ...
    def _handle_default(self, api_config, **kwargs):
        if api_config.api_name in self._NOT_ZERO_APIS:
            if "int" in self.dtype:
    ...
    def _handle_arange(self, api_config, **kwargs):
        tensor_num = 0
    ...
    def _handle_argmax_etc(self, api_config, **kwargs):
    ...
    def _handle_atan2(self, api_config, **kwargs):
    ...
    def _handle_bernoulli(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            dtype = "float32" if self.dtype == "bfloat16" else self.dtype
            self.numpy_tensor = numpy.random.random(self.shape).astype(dtype)

    def _handle_bincount(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            if "int" in self.dtype:
    ...
    def _handle_block_multihead_attention(self, api_config, **kwargs):
    ...
    def _handle_chunk(self, api_config, **kwargs):
    ...
    def _handle_conv2d_transpose(self, api_config, **kwargs):
    ...
    def _handle_cumsum(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "axis"):
    ...
    def _handle_clip(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
    ...
    def _handle_distribute_fpn_proposals(self, api_config, **kwargs):
    ...
    def _handle_dropout_etc(self, api_config, **kwargs):
    ...
    def _handle_empty(self, api_config, **kwargs):
    ...
    def _handle_eye(self, api_config, **kwargs):
        self.numpy_tensor = numpy.random.randint(0, 2048, size = self.shape)

    def _handle_expand_etc(self, api_config, **kwargs):
    ...
    def _handle_full(self, api_config, **kwargs):
    ...
    def _handle_gammainc_etc(self, api_config, **kwargs):
        if "int" in self.dtype:
            self.numpy_tensor = numpy.random.randint(0, 65535, size=self.shape).astype(self.dtype)
        else:
            dtype = "float32" if self.dtype == "bfloat16" else self.dtype
    ...
    def _handle_generate_proposals(self, api_config, **kwargs):
    ...
    def _handle_segment_etc(self, api_config, **kwargs):
    ...
    def _handle_sample_neighbors(self, api_config, **kwargs):
    ...
    def _handle_send_etc(self, api_config, **kwargs):
    ...
    def _handle_incubate_segment_etc(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "segment_ids"):
            batch_size = self.get_arg(api_config, 0, "x").shape[0]
            max_segments = numpy.random.randint(1, batch_size + 1)
            self.numpy_tensor = numpy.sort(
    ...
    def _handle_linalg_cov(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
    ...
    def _handle_linalg_eigh(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            if len(self.shape) < 2 or self.shape[-1] != self.shape[-2]:
                raise ValueError("Shape must have at least 2 dimensions and last two dimensions must be equal")
            batch_dims = self.shape[:-2]
    ...
    def _handle_linalg_lstsq(self, api_config, **kwargs):
    ...
    def _handle_linalg_lu_unpack(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            if len(self.shape) < 2:
    ...
    def _handle_linalg_pca_lowrank(self, api_config, **kwargs):
        self.numpy_tensor = numpy.random.randn(*self.shape).astype(self.dtype)

    def _handle_linspace(self, api_config, **kwargs):
        if "int" in self.dtype:
            self.numpy_tensor = (numpy.random.randint(0, 65535, size=self.shape)).astype(self.dtype)
        else:
            dtype = "float32" if self.dtype == "bfloat16" else self.dtype
    ...
    def _handle_masked_multihead_attention(self, api_config, **kwargs):
    ...
    def _handle_matrix_transpose(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            if len(self.shape) < 2:
                matrix_shape = [2, 2]
                if "int" in self.dtype:
    ...
    def _handle_reduce(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "axis"):
            self.numpy_tensor = self.generate_random_axes(api_config)

    def _handle_multinomial(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, 'x'):
    ...
    def _handle_multiplex(self, api_config, **kwargs):
    ...
    def _handle_multiply(self, api_config, **kwargs):
        if self.dtype=='bfloat16':
            self.dtype='float32'    
        self.numpy_tensor = numpy.random.random(self.shape).astype(self.dtype)

    def _handle_max_unpool_etc(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
    ...
    def _handle_nms(self, api_config, **kwargs):
    ...
    def _handle_adaptive_pool_etc(self, api_config, **kwargs):
    ...
    def _handle_adaptive_log_softmax_with_loss(self, api_config, **kwargs):
    ...
    def _handle_affine_grid(self, api_config, **kwargs):
    ...
    def _handle_alpha_dropout(self, api_config, **kwargs):
        if key == "x" or index == 0:
            if self.dtype=='bfloat16':
                self.dtype='float32'
            self.numpy_tensor = numpy.random.random(self.shape).astype(self.dtype)

    def _handle_interpolate(self, api_config, **kwargs):
        if key == "size" or index == 1 or key == "scale_factor" or index == 2:
            self.numpy_tensor = numpy.random.randint(1,128, size=self.shape).astype(self.dtype)

    def _handle_gather_tree(self, api_config, **kwargs):
    ...
    def _handle_gaussian_nll_loss(self, api_config, **kwargs):
        if self.check_arg(api_config, 2, "var"):
            dtype = "float32" if self.dtype == "bfloat16" else self.dtype
            self.numpy_tensor = (numpy.random.random(self.shape) + 1.0).astype(dtype)

    def _handle_hsigmoid_loss(self, api_config, **kwargs):
    ...
    def _handle_upsample(self, api_config, **kwargs):
    ...
    def _handle_margin_cross_entropy(self, api_config, **kwargs):
    ...
    def _handle_multi_margin_loss(self, api_config, **kwargs):
        if index==1 or key=='label':
            s=self.get_arg(api_config,0,'input')
            self.numpy_tensor = numpy.random.randint(0,s.shape[1], size=self.shape).astype(self.dtype)

    def _handle_cross_entropy(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "label"):
    ...
    def _handle_ctc_loss(self, api_config, **kwargs):
    ...
    def _handle_dice_loss(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "label"):
    ...
    def _handle_nll_loss(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "label"):
    ...
    def _handle_one_hot(self, api_config, **kwargs):
    ...
    def _handle_rnnt_loss(self, api_config, **kwargs):
    ...
    def _handle_sequence_mask(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"): 
    ...
    def _handle_softmax_with_cross_entropy(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "label"):
            logits = None
    ...
    def _handle_normal(self, api_config, **kwargs):
    ...
    def _handle_ones(self, api_config, **kwargs):
        if len(self.shape) == 0:
            self.numpy_tensor = numpy.array(numpy.random.randint(1, 2048), dtype=self.dtype)
        else:
            self.numpy_tensor = numpy.random.randint(1, 65535, size=self.shape).astype(self.dtype)
    
    def _handle_pad(self, api_config, **kwargs):
    ...
    def _handle_class_center_sample(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "label"):
            num_classes = self.get_arg(api_config, 1, "num_classes")
            self.numpy_tensor = numpy.random.randint(0, num_classes, size=self.shape).astype(self.dtype)
    
    def _handle_prod(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "axis"):
            self.numpy_tensor = self.generate_random_axes(api_config)

    def _handle_psroi_pool(self, api_config, **kwargs):
        if (index is not None and index == 0) or key == "x":
    ...
    def _handle_put_along_axis_etc(self, api_config, **kwargs):
    ...
    def _handle_quantile(self, api_config, **kwargs):
        if not (key == "x" or index == 0):
            self.numpy_tensor = numpy.random.rand(1).astype(self.dtype)
    
    def _handle_reshape_etc(self, api_config, **kwargs):
        if (index == 0 or key == "x"):
    ...
    def _handle_roi_align_etc(self, api_config, **kwargs):
        if (index is not None and index == 0)or key == "x":
            self.numpy_tensor = ((numpy.random.random(self.shape)) * 255).astype(self.dtype)
            if not hasattr(api_config, "x"):
                api_config.x = self.shape
    ...
    def _handle_repeat_interleave(self, api_config, **kwargs):
        if self.check_arg(api_config, 0, "x"):
            if self.dtype=='bfloat16':
                self.dtype='float32'
    ...
    def _handle_slice(self, api_config, **kwargs):
        if len(api_config.args) > 1:
    ...
    def _handle_scatter(self, api_config, **kwargs):
        if key == "index" or index == 1:
            d=self.get_arg(api_config, 0, "x")
            s=d.shape[0]
    ...
    def _handle_scatter_nd(self, api_config, **kwargs):
    ...
    def _handle_scatter_nd_add(self, api_config, **kwargs):
        if key == "index" or index == 1:
    ...
    def _handle_shard_index(self, api_config, **kwargs):
    ...
    def _handle_sum_etc(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "axis"):
            self.numpy_tensor = self.generate_random_axes(api_config)

    def _handle_split(self, api_config, **kwargs):
        if self.check_arg(api_config, 2, "axis"):
            x_shape = self.get_arg(api_config, 0, "x").shape
    ...
    def _handle_softmax(self, api_config, **kwargs):
    ...
    def _handle_standard_gamma(self, api_config, **kwargs):
        self.numpy_tensor =numpy.random.random(self.shape).astype(self.dtype)

    def _handle_standard_normal(self, api_config, **kwargs):
        if index==0 or key=='shape': 
            self.numpy_tensor =numpy.random.randint(1, 128, size=self.shape).astype(self.dtype)

    def _handle_strided_slice(self, api_config, **kwargs):
        s=self.get_arg(api_config,0,'x')
    ...
    def _handle_tensordot(self, api_config, **kwargs):
        if index == 0 or key == "x":
    ...
    def _handle_take_along_axis_etc(self, api_config, **kwargs):
        if self.check_arg(api_config, 1, "indices"):
    ...
    def _handle_clip_tensor(self, api_config, **kwargs):
    ...
    def _handle_gather_etc(self, api_config, **kwargs):
        if key == "index" or index == 1:
            s=self.get_arg(api_config, 0, "x")
    ...
    def _handle_gather_nd_etc(self, api_config, **kwargs):
        if key == "index" or index == 1:
                org=self.get_arg(api_config,0,'x')
                org=org.shape
    ...
    def _handle_index_select_etc(self, api_config, **kwargs):
    ...
    def _handle_tile_etc(self, api_config, **kwargs):
    ...
    def _handle_topk(self, api_config, **kwargs):
    ...
    def _handle_unflatten_etc(self, api_config, **kwargs):
    ...
    def _handle_unsqueeze(self, api_config, **kwargs):
    ...
    def _handle_variable_length_memory_efficient_attention(self, api_config, **kwargs):
    ...
    def _handle_zeros(self, api_config, **kwargs):
        elif api_config.api_name == "paddle.zeros":
            self.numpy_tensor = numpy.random.randint(0, 2048, size = self.shape)

    def _handle_zeropad2d(self, api_config, **kwargs):
    ...
    def _handle_getset_item_etc(self, api_config, **kwargs):
    ...
    def _handle_pow_etc(self, api_config, **kwargs):
    ...
    def _handle_rpow(self, api_config, **kwargs):
