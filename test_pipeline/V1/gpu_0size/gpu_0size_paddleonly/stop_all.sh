...
PYTHON_CMD_PATTERN="python engine.py --api_config_file=test_pipeline/gpu_0size/gpu_0size_paddleonly/0sizetensor_paddleonly_(1[0-9]|[1-9]|2[0-4])+\.txt --paddle_only=True"
SCRIPT_CMD_PATTERN="bash \./gpu_0size_paddleonly_run(1[0-9]|[1-9]|2[0-4])\.sh"

echo "Attempting to stop all related gpu_0size_paddleonly processes..."
echo ""
