...
PYTHON_CMD_PATTERN="python engine.py --api_config_file=test_pipeline/gpu_0size/gpu_0size_accuracy/0size_tensor_accuracy_(1[0-9]|[1-9]|2[0-4])+\.txt --accuracy=True"
SCRIPT_CMD_PATTERN="bash \./gpu_0size_accuracy_run(1[0-9]|[1-9]|2[0-4])\.sh"

echo "Attempting to stop all related gpu_0size_accuracy processes..."
echo ""
