...
with open("test_pipeline/cpu_accuracy/error_log.log", "w") as error_log_file:
    for i in range(14):
        test_log = f"test_pipeline/cpu_accuracy/cpu_accuracy_{i + 1}.log"
...
with open("test_pipeline/cpu_accuracy/error_config.txt", "w") as error_config_file:
    for config_entry in sorted(error_configs):
        error_config_file.write(config_entry + "\n")

with open("test_pipeline/cpu_accuracy/error_api.txt", "w") as error_api_file:
