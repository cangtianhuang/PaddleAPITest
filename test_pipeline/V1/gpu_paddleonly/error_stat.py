...
error_configs = set()
error_apis = set()
with open("test_pipeline/gpu_paddleonly/error_log.log", "w") as error_log:
    for i in range(19):
        test_log = f"test_pipeline/gpu_paddleonly/paddleonly_{i + 1}.log"
...
with open("test_pipeline/gpu_paddleonly/error_config.txt", "w") as error_config_file:
    for config in error_configs:
        error_config_file.write(config)
with open("test_pipeline/gpu_paddleonly/error_api.txt", "w") as error_api_file:
