...
PYTHON_CMD_PATTERN="python engine.py --api_config_file=test_pipeline/gpu_bigtensor/gpu_bigtensor_paddleonly/gpu_bigtensor_paddleonly_errorconfig_([1-8])+\.txt --paddle_only=True"
SCRIPT_CMD_PATTERN="bash \./gpu_bigtensor_paddleonly_run([1-8])\.sh"

echo "Attempting to stop all related gpu_bigtensor_paddleonly processes..."
echo ""
