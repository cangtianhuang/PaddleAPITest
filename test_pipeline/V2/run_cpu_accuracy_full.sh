...
FILE_PATTERN="tester/api_config/5_accuracy/accuracy_[1-8].txt,\
tester/api_config/5_accuracy/accuracy_cpu_*.txt,\
tester/api_config/5_accuracy/accuracy_gpu_error_dtype_diff.txt,\
tester/api_config/5_accuracy/accuracy_gpu_error_grads_diff.txt"
LOG_DIR="tester/api_config/test_log_cpu_accuracy_full"
NUM_GPUS=-1
