...
FILE_INPUT="report/0size_tensor_cpu/error_config.txt"
# FILE_PATTERN="report/0size_tensor_cpu/error_config.txt"
LOG_DIR="tester/api_config/test_log_cpu_0size_regr"
NUM_GPUS=-1
